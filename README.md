# CrediDriveP-FrontEnd
Repositorio del frontend de CrediDriveP, una aplicación desarrollada para el curso de Finanzas e Ingeniería Económica de la UPC. Este repositorio contiene la capa del FrontEnd, desarrollada con Flutter y Dart, encargada de la interacción con el usuario para la simulación de créditos vehiculares.
...
# 🚀 Guía de Despliegue Flutter — CrediDriveP-FrontEnd

**Repositorio:** `https://github.com/1ASI0642-2610-7024-G4-CrediDriveP/CrediDriveP-FrontEnd.git`

Esta guía cubre todo el proceso para clonar, configurar y ejecutar la aplicación Flutter **CrediDriveP-FrontEnd**, desde los requisitos previos hasta las buenas prácticas de desarrollo y ramas.
...
```bash
git clone https://github.com/1ASI0642-2610-7024-G4-CrediDriveP/CrediDriveP-FrontEnd.git
cd CrediDriveP-FrontEnd
...
Dentro de la carpeta del proyecto(`CrediDriveP-FrontEnd`), ejecuta:
...
3.  Selecciona la carpeta `CrediDriveP-FrontEnd`.
